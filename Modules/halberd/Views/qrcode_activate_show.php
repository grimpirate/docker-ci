...
<?= $this->section('title') ?><?= lang('QRAuth.qrcodeActivateTitle') ?> <?= $this->endSection() ?>
...
<div class="container d-flex justify-content-center p-5">
    <div class="card col-12 col-md-5 shadow-sm">
        <div class="card-body">
            <h5 class="card-title mb-5"><?= lang('QRAuth.qrcodeActivateTitle') ?></h5>
            ...
            <form action="<?= site_url('auth/a/verify') ?>" method="post">
                ...
                <div class="d-grid col-8 mx-auto m-3">
                    <button type="submit" class="btn btn-primary btn-block"><?= lang('QRAuth.send') ?></button>
                </div>
